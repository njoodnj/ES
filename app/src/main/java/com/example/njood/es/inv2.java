...
public class inv2 extends Activity {
    EditText r_rid, v_name , v_date ,num_of_invites,v_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v_name = (EditText) findViewById(R.id.visitorname);
    ...
    public void confirm (View v) {
        ...
        visitor_name = v_name.getText().toString();
        visit_date = v_date.getText().toString();
        number_of_invites = num_of_invites.getText().toString();
        ...
        if( v_name.getText().toString().length() == 0 ){
            v_name.setError( "Name is required!" );}
        if( v_date.getText().toString().length() == 0 ){
            v_date.setError( "date is required!" );}
        if( num_of_invites.getText().toString().length() == 0 ){
            num_of_invites.setError( "number of invites is required" );}
    ...
    class BackGround extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://10.0.2.2/webapp/inv2.php");
